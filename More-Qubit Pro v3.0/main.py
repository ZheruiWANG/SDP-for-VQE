...
def biSection_search_min(higher_bound, threshold, ep, ep_C1, dm_tilde, dm_tilde_C1, H, measurement_dataset, N, M, K, P):
    ...
    while abs(high - low) >= threshold:
        ...
        energy_C0_result, energy_C01_result = SDP_solver_min(coef, ep, ep_C1, dm_tilde, dm_tilde_C1, H, measurement_dataset, N, M, K, P)
...
def jordi(repetition, N_meas_list, higher_bound, threshold, N, M, K, P):
    ...
    return E_min, E_min_C0, E_min_C01, E_max, coef_min
def get_SDP_dataset(num_of_shot, N_meas_list, higher_bound, threshold, N, M, K, P):
    ...
    for repetition in range(num_of_shot):
        E_min, E_min_C0, E_min_C01, E_max, coef_min = jordi(
            repetition, 
